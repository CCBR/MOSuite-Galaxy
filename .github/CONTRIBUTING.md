...
```sh
git clone https://github.com/CCBR/MOSuite-Galaxy
```

> Cloning into 'MOSuite-Galaxy'... <br>
...
> remote: https://github.com/CCBR/MOSuite-Galaxy/pull/new/iss-10 <br>
> remote: <br>
> To https://github.com/CCBR/MOSuite-Galaxy <br> > <br> > [new branch] iss-10 -> iss-10 <br>
