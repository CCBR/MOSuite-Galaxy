...
- `1_mosuite-templates` - These templates modified manually; they are used to automatically update the blueprints. They were originally copied and modified from the NIDAP 1.0 templates.
