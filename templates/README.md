...
- `3_galaxy-tools` - The final XML files to define the Galaxy interface, generated with `galaxy_xml_synthesizer.py "templates/2_blueprints/*.json" --docker nciccbr/mosuite:v0.2.1 --output templates/3_galaxy-tools`.
